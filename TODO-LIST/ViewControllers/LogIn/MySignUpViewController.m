...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.signUpView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"Newwallpaper.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.additionalField setFrame:CGRectMake(fieldFrame.origin.x + 5.0f,
                                                         ...
                                                         fieldFrame.size.width - 10.0f,
                                                         fieldFrame.size.height)];*/
    [self.signUpView.usernameField setFrame:CGRectMake(37.0f, 195.0f, 250.0f, 50.0f)];
    [self.signUpView.passwordField setFrame:CGRectMake(37.0f, 245.0f, 250.0f, 50.0f)];
    //[self.signUpView.signUpButton setFrame:CGRectMake(128.0f, 385.0f, 250.0f, 40.0f)];
}
